    ...
    <>
      <div className="">
        <div className="flex justify-center">
          <img
            src={banner}
            className="w-full sm:h-32 md:h-32 lg:h-48"
            alt="Banner"
          />
        </div>
        <LatestSection />
        {/* Image Carousel Column */}
        <div className="relative my-2 overflow-hidden h-64">
          <div className="flex absolute w-full h-full animate-scrol">
            <img src={img1} alt="Image 1" className="h-64 w-auto rounded-lg mr-4" />
            <img src={img1} alt="Image 2" className="h-64 w-auto rounded-lg mr-4" />
            <img src={img1} alt="Image 3" className="h-64 w-auto rounded-lg mr-4" />
