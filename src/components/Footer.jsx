...
function Footer() {
  return (
    <footer id="footer" className="bg-black text-gray-300  py-6">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="animate__animated animate__fadeIn">
            ...
            <p className="text-gray-400 mb-4">
              Your comprehensive source for cricket statistics, analysis, and
              insights across all formats of the game.
            </p>
          </div>
            ...
            <ul className="space-y-2">
              ...
              <div className="flex items-center space-x-4">
                ...
                <a
                  ...
                  className="text-gray-400 hover:text-white transition duration-300"
                >
                    <img src="https://img.icons8.com/color/48/linkedin.png" className="w-7"/>
                  {/* <svg
                    className="w-6 h-6"
                    fill="currentColor"
                    viewBox="0 0 24 24"
        ...
        <div className="border-t border-gray-800 pt-6 mt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
           ...
           <p className="lg:text-sm text-xs text-gray-400">© Developed & Designed by <span className="text-yellow-500 lg:text-sm text-xs">Akash Kumar Kushwaha</span></p>
            <a
